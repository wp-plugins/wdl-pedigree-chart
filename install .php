...
Plugin Name: WDL Genealogy and Family History Pedigree Chart
...
<form action="" method="post" id="change_css">
   	...
   	<fieldset id="look">
   			<p class="form_heading">Table Name (Title)</p>
		...
		<fieldset id="look">
            ...
            <br />
            <p align="center"> ----- Changes in the Trial Version only available above this line -----
            <br /> ----- Please purchase the <a href="http://lyons-barton.com/wdl-pedigree-chart/" target="blank">full version</a> a for only AUD $9.99 <br />to activate the rest of the options ----- </p>
            <br />
            <br />
            <br />
             <p class="form_look">	
		...
		<fieldset id="look">
   			<p class="form_heading">Table Rows</p>
            ...
            Link Hover
      		...
      		<input name="link_hov_col" type="text" id="link_hov_col" size="25" maxlength="7" value="<? echo htmlspecialchars($link_hov_col)?>" />
   			...
   			<p class="form_heading">Table Width and Position</p>
            

            <p class="form_subheading">Sibling Table</p>
...
<p class="form_subheading">Spouse Table</p>
