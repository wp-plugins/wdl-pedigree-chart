...
class mingleforum{
	...
	function go() {
		...
		$this->o .= "<div id='wpf-info'><small>
			".__("Mingle Forum ", "mingleforum")." by <a href='http://cartpauj.icomnow.com'>cartpauj</a> | ElegantPress by <a href='http://theme4press.com'>Theme4Press</a> | Sponsored by <a href='http://sasinatherapy.sk'>Sasina Therapy</a><br /> 
			...
			if($sticky_threads){
				...
				foreach($sticky_threads as $thread){
					if($this->is_moderator($user_ID, $this->current_forum)){
						if($this->options['forum_use_seo_friendly_urls'])
							$strCommands = "<a href='".$this->forum_link.$this->current_forum."&getNewForumID&topic=$thread->id'><span class='button'>".__("Move Topic", "mingleforum")."</span></a> | <a href='".$this->forum_link.$this->current_forum."&delete_topic&topic=$thread->id' onclick='return wpf_confirm();'><span class='button'>".__("Delete Topic", "mingleforum")."</span></a>";
						else
							$strCommands = "<a href='".$this->get_forumlink($this->current_forum)."&getNewForumID&topic=$thread->id'><span class='button'>".__("Move Topic", "mingleforum")."</span></a> | <a href='".$this->get_forumlink($this->current_forum)."&delete_topic&topic=$thread->id' onclick='return wpf_confirm();'><span class='button'>".__("Delete Topic", "mingleforum")."</span></a>";
					...
					if($user_ID){
						...
						if($user_ID != $poster_id){
							...
							if($lp > $lv)
								$image = "<img src='$this->skin_url/images/new.png' alt='".__("New posts since last visit", "mingleforum")."'>";
						}
					}
					$sticky_img = "<img alt='' src='$this->skin_url/images/topic/normal_post_sticky.png'/>";
					$out .= "<tr>
	...
	function showthread($thread_id){
		...
		if(!current_user_can('administrator') && !is_super_admin($user_ID) && !$this->is_moderator($user_ID, $this->current_forum))
			...
			$out .= "<div class='wpf'>
						...
						<tr>
							<th width='113'><img src='$this->skin_url/images/topic/$image' align='left'/><span style='position:relative;top:10px;left:5px;'>".__("Author", "mingleforum")."</span></th>
			...
			foreach($posts as $post){
				...
				$out .= "<table class='wpf-post-table' width='100%' id='postid-$post->id'>
						<tr class='$class'>
							<td valign='top' width='100' class='author-info ";
 $out .= $this->get_userrole($post->author_id);
            $out .= "'><br /><br /><strong style='font-size:20px;'>".
							$this->profile_link($post->author_id, true)
								."</strong><div class='wpf-small'>";
                  ...
                  if($this->opt["forum_use_gravatar"])
                    $out .= $this->get_avatar($post->author_id);
							...
							<td class='topic-text' valign='top'>
								<table width='100%' cellspacing='0' cellpadding='0' class='wpf-meta-table'>
									...
									</tr><tr><td valign='top' colspan='2' class='topic_text'>";
										if(!$c)
		...
		if(!$this->is_closed() && ($user_ID || !$this->options['forum_require_registration'])) {
			$out .= "<table class='wpf-post-table' width='100%' id='wpf-quick-reply'>
              ...
              $this->form_buttons()."<br/>
								...
								<textarea rows='6' name='message' class='wpf-textarea' ></textarea>
						</td>
					</tr>";
	...
	function get_postmeta($post_id, $author_id){
		...
		$o = "<table width='100% cellspacing='0' cellpadding='0' style='margin:0; padding:0; border-collapse:collapse:' border='0'>
				<tr>
					<td width='10%'><strong>".$this->get_postname($post_id)."</strong><br /><small><strong>".__("on:", "mingleforum")."&nbsp;</strong>".$this->get_postdate($post_id)."</small></td>";
					if($this->options['forum_use_seo_friendly_urls'])
					{
						if(is_user_logged_in() && !$this->is_closed())
							 $o .= "<td nowrap='nowrap' width='2%'><img src='$this->skin_url/images/buttons/quote.png' alt='' align='left'><a href='$this->post_reply_link&quote=$post_id.$this->curr_page'> ".__("Quote", "mingleforum")."</a></td>";
						if($this->is_moderator($user_ID, $this->current_forum))
							 $o .= "<td nowrap='nowrap' width='2%'><img src='$this->skin_url/images/buttons/delete.png' alt='' align='left'><a onclick=\"return wpf_confirm();\" href='".$this->thread_link.$this->current_thread."&remove_post&id=$post_id'> ".__("Remove", "mingleforum")."</a></td>";
						if(($this->is_moderator($user_ID, $this->current_forum)) || ($user_ID == $author_id && $user_ID))
							 $o .= "<td nowrap='nowrap' width='2%'><img src='$this->skin_url/images/buttons/modify.png' alt='' align='left'><a href='".$this->base_url."editpost&id=$post_id&t=$this->current_thread.0'>" .__("Edit", "mingleforum")."</a></td>";
					}
					else
					{
						if(is_user_logged_in() && !$this->is_closed())
							 $o .= "<td nowrap='nowrap' width='2%'><img src='$this->skin_url/images/buttons/quote.png' alt='' align='left'><a href='$this->post_reply_link&quote=$post_id.$this->curr_page'> ".__("Quote", "mingleforum")."</a></td>";
						if($this->is_moderator($user_ID, $this->current_forum))
							 $o .= "<td nowrap='nowrap' width='2%'><img src='$this->skin_url/images/buttons/delete.png' alt='' align='left'><a onclick=\"return wpf_confirm();\" href='".$this->get_threadlink($this->current_thread)."&remove_post&id=$post_id'> ".__("Remove", "mingleforum")."</a></td>";
						if(($this->is_moderator($user_ID, $this->current_forum)) || ($user_ID == $author_id && $user_ID))
							 $o .= "<td nowrap='nowrap' width='2%'><img src='$this->skin_url/images/buttons/modify.png' alt='' align='left'><a href='".$this->base_url."editpost&id=$post_id&t=$this->current_thread.0'>" .__("Edit", "mingleforum")."</a></td>";
					}
				$o .= "</tr>
	...
	function mydefault(){
		...
		$this->o .= apply_filters('wpwf_new_posts',"<table>
					<tr style='background:none!important;'>
						<td><small><img alt='' align='top' src='$this->skin_url/images/new_some.png' /> ".__("New posts", "mingleforum")." <img alt='' align='top' src='$this->skin_url/images/new_none.png' /> ".__("No new posts", "mingleforum")." - <a href='".get_permalink($this->get_pageid()).$delim."markallread=true'>".__("Mark All Read", "mingleforum")."</a></small></td>
					</tr>
	...
	function vforum($groupid){
		...
		$this->o .= apply_filters('wpwf_new_posts',"<table>
					<tr>
						<td><small><img alt='' align='top' src='$this->skin_url/images/new_some.png' /> ".__("New posts", "mingleforum")." <img alt='' align='top' src='$this->skin_url/images/new_none.png' /> ".__("No new posts", "mingleforum")."</small></td>
					</tr>
				</table><br class='clear'/>");
		$this->footer();
	}
	...
	function setup_menu(){
		...
		if(is_plugin_active('mingle/mingle.php'))
		{
			...
			$link = "<a href='" . $myProfURL2 . "' title='".__("My profile", "mingleforum")."'><span id='user_button'>".__("My Profile", "mingleforum")."</span></a>";
		}
		else
		{
			$link = "<a href='".$this->base_url."profile&id=$user_ID' title='".__("My profile", "mingleforum")."'><span id='user_button'>".__("My Profile", "mingleforum")."</span></a>";
		}
		...
		{
			$menuitems = array(
								"home" 	    => "<a href='".$this->home_url."'><span id='home_button'>".__("Forum Home", "mingleforum")."</span></a>",
								"logout" 	=> "<a href='$this->logout_link'>".__("Log out", "mingleforum")."</a>",
								"profile" 	=> $link,
								"reply" 	=> "<a href='".$this->get_post_reply_link()."'><span id='reply_button'>".__("Reply", "mingleforum")."</span></a>",
								"new_topic" => "<a href='".$this->get_addtopic_link()."'><span id='new_button'>".__("New Topic", "mingleforum")."</span></a>",
								"feed" 		=> "<a href='$this->topic_feed_url"."$this->current_thread'><span id='rss_button'>".__("RSS-Feed", "mingleforum")."</span></a>",
								"sticky" 	=> "<a href='".$this->thread_link.$this->current_thread.".".$this->curr_page."&sticky&id=$this->current_thread'><span id='sticky_button'>".__("Sticky", "mingleforum")."</span></a>",
								"unsticky" 	=> "<a href='".$this->thread_link.$this->current_thread.".".$this->curr_page."&sticky&id=$this->current_thread'><span id='undosticky_button'>".__("Undo Sticky", "mingleforum")."</span></a>",
								"closed" 	=> "<a href='".$this->thread_link.$this->current_thread.".".$this->curr_page."&closed=1&id=$this->current_thread'><span id='close_button'>".__("Close", "mingleforum")."</span></a>",
								"unclosed" 	=> "<a href='".$this->thread_link.$this->current_thread.".".$this->curr_page."&closed=0&id=$this->current_thread'><span id='reopen_button'>".__("Re-open", "mingleforum")."</span></a>",
								"move" 		=> "<a href='".$this->forum_link.$this->current_forum.".".$this->curr_page."&getNewForumID&topic=$this->current_thread'><span id='move_button'>".__("Move Topic", "mingleforum")."</span></a>"
				);
		}
		else
		{
			$menuitems = array(
							...
							"new_topic" => "<a href='".$this->get_addtopic_link()."'><span id='new_button'>".__("New Topic", "mingleforum")."</span></a>",
							"feed" 		=> "<a href='$this->topic_feed_url"."$this->current_thread'><span id='rss_button'>".__("RSS-Feed", "mingleforum")."</span></a>",
							"sticky" 	=> "<a href='".$this->get_threadlink($this->current_thread)."&sticky&id=$this->current_thread'><span id='sticky_button'>".__("Sticky", "mingleforum")."</span></a>",
							"unsticky" 	=> "<a href='".$this->get_threadlink($this->current_thread)."&sticky&id=$this->current_thread'><span id='undosticky_button'>".__("Undo Sticky", "mingleforum")."</span></a>",
							"closed" 	=> "<a href='".$this->get_threadlink($this->current_thread)."&closed=1&id=$this->current_thread'><span id='close_button'>".__("Close", "mingleforum")."</span></a>",
							"unclosed" 	=> "<a href='".$this->get_threadlink($this->current_thread)."&closed=0&id=$this->current_thread'><span id='reopen_button'>".__("Re-open", "mingleforum")."</span></a>",
							"move" 		=> "<a href='".$this->get_forumlink($this->current_forum)."&getNewForumID&topic=$this->current_thread'><span id='move_button'>".__("Move Topic", "mingleforum")."</span></a>");
		}
...
/****************************************************/
	...
	function get_avatar($user_id, $size = 50){
	...
	function header(){
		...
		if($user_ID){
			...
			$meta = "<div style='float:left'>".__("Your last visit was:", "mingleforum")." ".$this->format_date($this->last_visit())."<br /><br />";
			$meta .= $this->get_inbox_link();
			$meta .= "<a href='".$this->base_url."shownew'>".__("Show new topics since your last visit", "mingleforum")."</a>";
			$meta .= "<a href='".$this->base_url."editprofile&user_id=$user_ID'>".__("Edit your forum options", "mingleforum")."</a>";
			$meta .= $ProfLinky;
			...
			$avatar = "<td class='wpf-alt' width='6%'>".$this->get_avatar($user_ID, 50)."</td>";
			$colspan = "colspan = '2'";
		}
		else{
...
DISABLED THIS IN 1.0.25*/
	...
	function form_buttons(){
		$button = '
	<a title="'.__("Bold", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[b]", "[/b]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/b.png" /></a>
	<a title="'.__("Italic", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[i]", "[/i]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/i.png" /></a>
	<a title="'.__("Underline", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[u]", "[/u]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/u.png" /></a>
	<a title="'.__("Strikethrough", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[s]", "[/s]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/s.png" /></a>
	<a title="'.__("Code", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[code]", "[/code]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/code.png" /></a>
	<a title="'.__("Quote", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[quote]", "[/quote]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/quote.png" /></a>
	<a title="'.__("List", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[list]", "[/list]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/list.png" /></a>
	<a title="'.__("List item", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[*]", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/li.png" /></a>
	<a title="'.__("Link", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[url]", "[/url]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/url.png" /></a>
	<a title="'.__("Image", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[img]", "[/img]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/img.png" /></a>
	<a title="'.__("Email", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[email]", "[/email]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/email.png" /></a>
	...
	<a title="'.__("Embed YouTube Video", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[embed]", "[/embed]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/yt.png" /></a>
	<a title="'.__("Embed Google Map", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText("[map]", "[/map]", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/bbc/gm.png" /></a>';
		return $button;
	}
	...
	<a title="'.__("Big Grin", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" :D ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/biggrin.gif" /></a>
	<a title="'.__("Sad", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" :( ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/sad.gif" /></a>
	<a title="'.__("Neutral", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" :| ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/neutral.gif" /></a>
	<a title="'.__("Razz", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" :P ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/razz.gif" /></a>
	<a title="'.__("Mad", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" :x ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/mad.gif" /></a>
	<a title="'.__("Confused", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" :? ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/confused.gif" /></a>
	<a title="'.__("Eek!", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" :o ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/eek.gif" /></a>
	<a title="'.__("Wink", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" ;) ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/wink.gif" /></a>
	<a title="'.__("Surprised", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" 8O ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/surprised.gif" /></a>
	<a title="'.__("Cool", "mingleforum").'" href="javascript:void(0);" onclick=\'surroundText(" 8-) ", "", document.forms.addform.message); return false;\'><img src="'.$this->skin_url.'/images/smilies/cool.gif" /></a>';
		return $button;
	}
		...
		switch($this->current_view){
			case MAIN:
				...
				$o .= "<table class='wpf-table' width='100%' cellspacing='0' cellpadding='0'>";
						$o .= "<tr>
									<th align='center' colspan='2'>".__("Info", "mingleforum")."</th>
								</tr>
								<tr>
								</tr>
								<tr>
									<td width='3%' class='forumIcon' align='center'><img alt='' src='$this->skin_url/images/icons/info.png' /></td>
									<td>
					...
					<td>
						<table class='wpf-table' cellpadding='0' cellspacing='0' width='100%'>
							<tr>
								...
								<td rowspan='9' valign='top' width='1%'>".$this->get_avatar($user_id, 50)."</td>
							</tr>
							<tr>
	...
	function get_topic_image_two($thread){
		...
		if($post_count < $this->opt['hot_topic']){
			return "normal_post.png";
		}
		if($post_count >= $this->opt['hot_topic'] && $post_count < $this->opt['veryhot_topic']){
			return "hot_post.png";
		}
		if($post_count >= $this->opt['veryhot_topic']){
			return "my_hot_post.png";
		}
	}
